# Self-Signed Certs required to install Linkerd
...
resource "helm_release" "linkerd" {
  ...
  # Required to connect to Aurora PostgreSQL
  set {
    name  = "global.proxyInit.ignoreInboundPorts"
    value = "5432"
    # Setting type is important for strings that are numbers!
    type = "string"
  }
